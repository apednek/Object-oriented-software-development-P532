...
public class GameEvent implements Loadable
{
	...
	public static int INTERACT = 10;
	
	public static int MOUSE_DRAG = 8;
	public static int MOUSE_DRAG_RELEASE = 9;
	...
	public static GameEvent MouseDragEvent()
	{
		return new GameEvent(MOUSE_DRAG);
	}
	public static GameEvent MouseReleaseEvent()
	{
		return new GameEvent(MOUSE_DRAG_RELEASE);
	}
